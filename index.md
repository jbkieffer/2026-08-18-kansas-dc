...
# Required variables
venue: "University of Kansas (KU); Kansas State University (K-State)"        # brief name of the institution that hosts the workshop without address (e.g., "Euphoric State University")
address: "multi-site"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria"), videoconferencing URL, or 'online'
...
humandate: "August 18–19, 2026"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
helper: ["Kristie Beaty, PhD (KU)", "Jamene Brooks-Kieffer (KU)", "E Durham (KU)", "Austin Nguyen (KU)", "Teresa Shippy, PhD (K-State)", "Gwendolyn Sibley (K-State)", "Will Tank, PhD (K-State)"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
